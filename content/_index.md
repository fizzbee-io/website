  ...
  <section class="fb-hero" aria-labelledby="fb-hero-title">
    <div class="fb-hero__inner">
      <div class="fb-hero__copy">
        ...
        <p class="fb-hero__lead">Describe your design in a small Python-like model. FizzBee explores the state space, renders diagrams, and turns the model into tests.</p>

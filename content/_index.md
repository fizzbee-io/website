  ...
  <section class="fb-hero" aria-labelledby="fb-hero-title">
    <div class="fb-hero__inner">
      <div class="fb-hero__copy">
        ...
        <p class="fb-hero__lead">Write design specifications in a Python-like modeling language with your AI. FizzBee verifies the design and turns the model into a test harness for your code.</p>
